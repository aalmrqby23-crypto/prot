...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '8043726894:AAEmL5GJEwuIWstJqUQRyebGni_Rzm1UnxU';
...
#_________________
$chall = "ghghsue";
$useradmin = "Almshaks_VIP";
$sim =-1003266055225; #القناة الرسمية
$PAY =-1003184907361; #الارقام المكتملة
$ess =-1003230126681; #عمليات شراء الارقام
$eer =-1002923937447; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7645454552){
$sudo=$chat_id;
}elseif($chat_id==7645454552){
$sudo=$chat_id;
}else{
$sudo==7645454552;
}
...
*- في بوت @Cgsjigsbot* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
- لفحص الرقم, أضغط على زر *رؤية الرقم في واتسأب* بعد شراء الرقم, سيقوم بتوجيهك إلى الواتساب, في حالة قال لك *إن رقم الهاتف هذا +967••• @Cgsjigsbot ليس في واتسأب* هذا يعني أن الرقم جديد ولم يستخدم في واتسأب من قبل, *أما في الحالات الأخرى فهذا يعني أن الرقم مستخدم في واتسأب ولا نتحمل مسؤولية تفعيلة في أي حال من الأحوال.*
